...
ecommerce <- readtext("ecommerceData.csv")

# construct corpus
corpus <- corpus(ecommerce$text.1)

# construct document feature matrix
dfmat <- corpus |> tokens(remove_punct = TRUE) |> tokens_remove(stopwords("en")) |> dfm()

# sort dfm by frequence
dfm_sort(dfmat)
```
